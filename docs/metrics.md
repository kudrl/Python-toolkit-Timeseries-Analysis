...
Подробное описание математических предпосылок, preprocessing, AR-диагностики,
лагов и интерпретации матриц см. в [Математика и предварительный анализ данных](math_and_data_analysis.md).
